        ...
        switch(command1) {
          ...
          case "2" :   
            ...
            for (int i = 0; i < this.size; i ++) {
              Register register = this.members[i];
              if (register.id == id) {               
                String adress = Prompt.inputString(String.format("주소(%s): ", register.adress));
                String phone = Prompt.inputString(String.format("번호(%s)" , register.phone));
